      ...
      <div className={style.productlist_table_div}>
        <table>
          <tr className={style.productlist_header_tr}>
            ...
            <th className={style.productlist_th2}> نام دانشگاه </th>
            <th className={style.productlist_th3}>مسئول امور آزمایشگاه ها </th>
            <th className={style.productlist_th4}>آدرس </th>
            <th className={style.productlist_th5}>شماره تماس </th>
          </tr>
          {table &&
            table &&
            currentItems &&
