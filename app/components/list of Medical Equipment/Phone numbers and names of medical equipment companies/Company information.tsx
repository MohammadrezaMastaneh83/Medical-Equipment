...
import style from "./Company information.module.css";
import Image from "next/image";
import { useState, useEffect } from "react";
export default function CompanyInformation() {
  const table = [
    {
      company: "آرشان آریا مد",
      managerName: "ایران",
      fax: "021 - 55 66 44 55",
      adress: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ ",
      number: "021 - 55 88 99 77",
      number2: "0912 581 99 41",
    },
    {
      company: "ابتکار توسعه درمان",
      managerName: "اسپانیا",
      fax: "021 - 55 66 44 55",
      adress: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ ",
      number: "021 - 55 88 99 77",
  ...
  return (
    <div className={style.companyinformation_all}>
      ...
      <div className={style.productlist_table_div}>
        <table>
          <tr className={style.productlist_header_tr}>
            ...
            <th className={style.productlist_th2}>نام شرکت </th>
            <th className={style.productlist_th3}>نام مدیر عامل</th>
            <th className={style.productlist_th4}> شماره فکس</th>
            <th className={style.productlist_th5}>آدرس</th>
            <th className={style.productlist_th6}>تلفن</th>
          </tr>
          {table &&
            table &&
            currentItems &&
            currentItems.map((item: any, index: any) => {
              ...
              return (
                <tr key={index} style={{ background: color }}>
                  ...
                  <td className={style.productlist_td3}>{item.managerName}</td>
                  <td className={style.productlist_td4}>{item.fax}</td>
                  <td className={style.productlist_td5}>{item.adress}</td>
                  <div className={style.productlist_td6}>
                    <td className={style.productlist_td_div2}>
                      {item.number}
                    </td>
                    <td className={style.productlist_td_div2} style={index ==1 || index ==4 || index==5 || index ==6 ? {display:"none"} : {}}>{item.number2}</td>
                  </div>
                </tr>
              );
            })}{" "}
