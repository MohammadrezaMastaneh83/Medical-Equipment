"use client";
import style from "./Boss information.module.css";
...
const table = [
  {
    univercity: "اردبیل",
    Bosse: "دکتر پارسا یاهو",
    adres: "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ ",
...
export default function BossInformation() {
      ...
      <div className={style.productlist_table_div}>
        <table>
          <tr className={style.productlist_header_tr}>
            ...
            <th className={style.productlist_th2}>دانشگاه های علوم پزشکی </th>
            <th className={style.productlist_th3}>دانشگاه های علوم پزشکی </th>
            <th className={style.productlist_th4}>دانشگاه های علوم پزشکی </th>
            <th className={style.productlist_th5}>دانشگاه های علوم پزشکی </th>
          </tr>
          {table &&
            table &&
            currentItems &&
              ...
              return (
                show && (
                  <tr key={index} style={{ background: color }}>
                    ...
                    <td className={style.productlist_td4}>{item.adres}</td>
                    <td className={style.productlist_td5}><div className={style.productlist_td_div2}>{item.call}</div></td>
                  </tr>
                )
              );
            })}{" "}
